...
import { TAB_ROUTES } from '../../navigation/TabNavigation';

const ScanagainConnecting = ({navigation}:any) => {
        ...
        <View style={styles.second_layer}>
          <View style={styles.third_layer}>
            {connecting ? (
              <>
                <Image
                  style={[styles.key_image,{width:240}]}
                  resizeMode="contain"
                  source={imgUrl.key_to_car}
                />
...
export default ScanagainConnecting
